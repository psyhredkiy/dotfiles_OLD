...
},{"../shared-utils/parse-user-agent-string.es6":45,"./chrome-wrapper.es6":23,"./load.es6":34,"./settings.es6":39}],20:[function(require,module,exports){
'use strict';
...
},{"./chrome-events.es6":22,"./settings.es6":39}],21:[function(require,module,exports){
'use strict';
...
var BANNER_SETTING = 'bannerEnabled';
var BANNER_EXP_NAME = 'privacy_nudge';

var bannerUrls = {
    hostnames: ['www.google.com', 'images.google.com', 'books.google.com'],
    paths: [
    // homepage
    '/',
    // SERP
...
function isOtherSerp(url) {
    ...
    return urlObj.hostname === 'www.google.com' && urlObj.pathname === '/search' && hasQuery;
}
...
function isValidTransitionType(details) {
    ...
    return details.transitionType === 'form_submit' || details.transitionType === 'generated' ||
...
function handleOnCommitted(details) {
    ...
    var activeExp = settings.getSetting('activeExperiment');

    if (activeExp && activeExp.name === BANNER_EXP_NAME) {
        var enabled = settings.getSetting(BANNER_SETTING);
        // cast bool to int
        pixelOps.be = +enabled;
    } else {
        pixelOps.be = -1;
...
function handleOnDOMContentLoaded(details) {
    ...
    if (!activeExp || !activeExp.name === BANNER_EXP_NAME || !settings.getSetting(BANNER_SETTING)) return;
...
var Banner = function () {
    return {
        handleOnCommitted: handleOnCommitted,
        handleOnDOMContentLoaded: handleOnDOMContentLoaded,
        firePixel: firePixel,
...
},{"./experiments.es6":31,"./pixel.es6":36,"./settings.es6":39,"./utils.es6":44}],22:[function(require,module,exports){
'use strict';
...
},{"../../data/constants":14,"./atb.es6":19,"./banner.es6":21,"./chrome-wrapper.es6":23,"./companies.es6":30,"./experiments.es6":31,"./https-service.es6":32,"./https.es6":33,"./pixel.es6":36,"./redirect.es6":38,"./settings.es6":39,"./storage/https.es6":40,"./storage/tds.es6":41,"./tab-manager.es6":42,"./trackers.es6":43,"./utils.es6":44}],23:[function(require,module,exports){
'use strict';
...
},{"../../../data/constants":14,"../pixel.es6":36,"../utils.es6":44}],26:[function(require,module,exports){
'use strict';
...
},{"../chrome-wrapper.es6":23,"../privacy-practices.es6":37,"../settings.es6":39,"../utils.es6":44,"./../storage/tds.es6":41,"@duckduckgo/privacy-grade":1,"tldts":13}],27:[function(require,module,exports){
'use strict';
...
},{"../companies.es6":30,"./../chrome-wrapper.es6":23,"./https-redirects.es6":25,"./site.es6":26,"./tracker.es6":29}],28:[function(require,module,exports){
"use strict";
...
},{"../companies.es6":30,"../storage/tds.es6":41}],30:[function(require,module,exports){
'use strict';
...
},{"./chrome-wrapper.es6":23,"./classes/company.es6":24,"./classes/top-blocked.es6":28,"./migrate.es6":35}],31:[function(require,module,exports){
'use strict';
...
},{"../../data/experiments-out":16,"./atb-utils.es6":18,"./settings.es6":39}],32:[function(require,module,exports){
'use strict';
...
},{"../../data/constants":14,"../shared-utils/sha1":46,"punycode":6}],33:[function(require,module,exports){
(function (Buffer){
'use strict';
...
},{"./chrome-wrapper.es6":23,"./https-service.es6":32,"./pixel.es6":36,"./settings.es6":39,"./tab-manager.es6":42,"./utils.es6":44,"buffer":7,"jsbloom":10,"tldts":13}],34:[function(require,module,exports){
'use strict';
...
},{"./chrome-wrapper.es6":23}],35:[function(require,module,exports){
'use strict';
...
},{"../shared-utils/parse-user-agent-string.es6":45,"./chrome-wrapper.es6":23,"./load.es6":34,"./settings.es6":39}],37:[function(require,module,exports){
'use strict';
...
},{"../../data/constants":14,"../../data/tosdr":17,"./utils.es6":44,"tldts":13}],38:[function(require,module,exports){
'use strict';
...
},{"./atb.es6":19,"./chrome-wrapper.es6":23,"./companies.es6":30,"./https.es6":33,"./settings.es6":39,"./tab-manager.es6":42,"./trackers.es6":43,"./utils.es6":44}],39:[function(require,module,exports){
'use strict';
...
},{"../../data/defaultSettings":15,"./chrome-wrapper.es6":23}],40:[function(require,module,exports){
(function (Buffer){
'use strict';
...
},{"../../../data/constants":14,"./../load.es6":34,"./../settings.es6":39,"buffer":7,"dexie":8}],41:[function(require,module,exports){
'use strict';
...
},{"../../../data/constants":14,"./../chrome-wrapper.es6":23,"./../load.es6":34,"./../settings.es6":39,"dexie":8}],42:[function(require,module,exports){
'use strict';
...
},{"./chrome-wrapper.es6":23,"./classes/tab.es6":27,"./companies.es6":30,"./settings.es6":39}],43:[function(require,module,exports){
'use strict';
...
},{"./utils.es6":44,"@duckduckgo/privacy-grade":1,"tldts":13}],44:[function(require,module,exports){
'use strict';
...
},{"../../data/constants":14,"../shared-utils/parse-user-agent-string.es6":45,"./storage/tds.es6":41,"tldts":13}],45:[function(require,module,exports){
'use strict';
